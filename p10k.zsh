# Generated by Powerlevel10k configuration wizard on 2020-06-26 at 08:32 BST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    #iaws                     # aws profile (https://docs.aws.amazon.com/cli/latest/userguide/cli-configure-profiles.html)
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ALL=true
  ...
  typeset -g POWERLEVEL9K_AWS_SHOW_ALL=true
